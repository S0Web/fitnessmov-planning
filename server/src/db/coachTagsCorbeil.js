...
// + discipline(s) (cumulables). Utilisé par backfillCoachTags.js pour compléter la
// table `coaches` existante (ne crée un nouveau coach que si aucun ne porte déjà ce
// prénom ; ne remplace jamais un téléphone déjà renseigné).
...
module.exports = [
  ...
  { prenom: 'Jen',       nom: '',           telephone: '06 70 48 04 72', poledance: true },
  { prenom: 'Clarisse',  nom: '',           telephone: '07 69 07 24 57', poledance: true },
  { prenom: 'Sarah',     nom: '',           telephone: '06 85 30 82 96', poledance: true },
  ...
  { prenom: 'Bénédicte', nom: '',           telephone: '07 70 04 02 89', poledance: true },
];
