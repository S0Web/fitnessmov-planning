...
module.exports = [
  ...
  // Ajoutés lors de l'import de l'historique Corbeil-Essonnes (juin 2024 - août 2025)
  { nom: 'Aquafitness',          categorie: 'aqua' },
  { nom: 'Aquafitness Sunday',   categorie: 'aqua' },
  { nom: 'AquaBike Sunday',      categorie: 'aqua' },
  { nom: 'Crossfit',             categorie: 'fitness' },
  { nom: 'Djembel',              categorie: 'fitness' },
  { nom: 'Hip-hop',              categorie: 'fitness' },
  { nom: 'Grit',                 categorie: 'fitness' },
  { nom: '100% Fessiers',        categorie: 'fitness' },
  { nom: 'Boxe',                 categorie: 'fitness' },
  { nom: 'Boxe kids',            categorie: 'fitness' },
  { nom: 'Swiss ball',           categorie: 'fitness' },
  { nom: 'Dance Taicienne',      categorie: 'fitness' },
  { nom: 'Coaching ladies small groupe', categorie: 'fitness' },
  { nom: 'April attack',         categorie: 'fitness' },
  { nom: 'LIA',                  categorie: 'fitness' },
  { nom: 'LIA inter',            categorie: 'fitness' },
  { nom: 'Pole dance souplesse', categorie: 'fitness' },
  { nom: 'Step',                 categorie: 'fitness' },
];
